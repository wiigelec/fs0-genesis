...
**DP001-REQUIREMENTS-027**
An exact Design Proposal revision binding shall make the consumed revision both uniquely identifiable and retrievable for later governed review.

**DP001-REQUIREMENTS-028**
Within an established governed repository, a repository-native revision identity may satisfy exact Design Proposal revision binding when the referenced revision remains resolvable within that repository's governed history.
